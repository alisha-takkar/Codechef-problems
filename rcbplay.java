/*  Problem :
    ...
    Explanation:
    Test Case 1: There are 8 games remaining. Out of these 8 games, if RCB wins 2 games, loses 4 games and draws the remaining 2 games 
                 they will have a total of 10 points, this shows that it is possible for RCB to qualify for the playoffs.
    ...
    Test Case 3: If RCB wins all their remaining games, they will have end up with 8 points.
                 (4+2∗2=8), hence it is possible for them to qualify for the playoffs.
*/
